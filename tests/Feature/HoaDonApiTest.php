...
class HoaDonApiTest extends TestCase
{
    ...
    public function test_staff_can_create_and_search_hoa_don(): void
    {
        ...
        $createResponse
            ...
            ->assertJsonPath('data.tien_thanh_toan', '495000.00');

        $hoaDonId = $createResponse->json('data.id_hoa_don');

        $this->postJson("/api/hoa-dons/{$hoaDonId}/chi-tiets", [
            'id_lo' => $loThuoc->id_lo,
            'so_luong' => 1,
            'gia_ban' => 500000,
        ])->assertCreated();
    ...
    public function test_admin_can_view_statistics(): void
    {
        ...
        $hoaDonMot = HoaDon::factory()->create([
        ...
        $hoaDonHai = HoaDon::factory()->create([
            'id_nhan_vien' => $staff->id_nhan_vien,
            'id_khach_hang' => $khachHang->id_khach_hang,
            'tong_tien' => 500000,
            'giam_gia' => 0,
        ...
        ChiTietHoaDon::factory()->create([
            'id_hoa_don' => $hoaDonMot->id_hoa_don,
            'id_lo' => $loThuoc->id_lo,
            'so_luong' => 1,
            'gia_ban' => 1000000,
            'thanh_tien' => 1000000,
        ...
        ChiTietHoaDon::factory()->create([
            'id_hoa_don' => $hoaDonHai->id_hoa_don,
            'id_lo' => $loThuoc->id_lo,
            'so_luong' => 1,
            'gia_ban' => 500000,
            'thanh_tien' => 500000,
